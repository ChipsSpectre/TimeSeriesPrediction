...
if __name__ == "__main__":
    ...
    data_points = DataGenerator.generate_sine(N=5000, start=0, end=2 * np.pi)
    ...
    net = TwoLayerNet(n_input=in_seq_len, n_hidden=100, n_output=out_seq_len)
    net.compile("adam", "mse")

    history = net.train(train_x, train_y, val_x, val_y, epochs=100)
